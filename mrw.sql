...
INSERT INTO `blog_case` VALUES ('31', '0', '12', 'PMA微商控价系统', '/static/uploads/20190419/e48e40dd834be28b80dc34c35124fd41.jpg', '控价授权防伪', '<p>控价授权防伪</p><p><br></p>', '0', '0', '1', '0', null, '0', '1', '0', '2019-04-19 14:17:06', '0', null, null);
...
INSERT INTO `system_config` VALUES ('47', 'description', 'basic', 'string', '微商控价系统、微商管理系统、微商云仓系统、微商新零售商城,详情咨询黄经理 ：180-5428-5450', '网站描述', '0', '2018-09-17 16:51:29', '0', null, null);
...
CREATE TABLE `system_login_record` (
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=544 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='博客会员登录记录';
...
INSERT INTO `system_login_record` VALUES ('543', '1', '1', '127.0.0.1', '', '', '', '', '', '【账号登录】登录成功，正在进入系统！', '1', '2019-04-24 18:18:25');
